    ...
    value = {
        ...
        'control': {
            ...
            'contact': {
                ...
                'episodes': [],
                'exact_pair_raw_count': 0,
                'expected_pair': pair,
                'first_qualifying_contact': None,
                'raw_contact_record_count': 0,
                'records': [],
            },
            ...
            'timeline': {
                ...
                'release_contact_message_end_count': 0,
                'release_contact_message_start_count': None,
        ...
        'quality': {
            ...
            'buffers': {
                'actor_state': _buffer(),
                'command': _buffer(),
                'contact_records': _buffer(),
                'contact_summaries': _buffer(),
